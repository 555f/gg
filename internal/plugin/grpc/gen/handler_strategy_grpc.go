...
var _ HandlerStrategy = &HandlerStrategyGRPC{}

type HandlerStrategyGRPC struct{}

// HandlerFunc implements HandlerStrategy.
func (s *HandlerStrategyGRPC) HandlerFunc(method string, endpoint jen.Code, middlewares jen.Code, bodyFunc ...jen.Code) (typ jen.Code) {
...
func (*HandlerStrategyGRPC) ID() string {
	return "default"
}

// LibArgName implements HandlerStrategy.
func (*HandlerStrategyGRPC) LibArgName() string {
	return "r"
}

// LibType implements HandlerStrategy.
func (*HandlerStrategyGRPC) LibType() (typ jen.Code) {
	return jen.Op("*").Qual(jsonrpcPkg, "Server")
}

// MiddlewareType implements HandlerStrategy.
func (*HandlerStrategyGRPC) MiddlewareType() jen.Code {
	return jen.Qual(jsonrpcPkg, "Option")
}

// ReqArgName implements HandlerStrategy.
func (*HandlerStrategyGRPC) ReqArgName() string {
	return "params"
}

// RespArgName implements HandlerStrategy.
func (*HandlerStrategyGRPC) RespArgName() string {
	return "r"
}

func NewHandlerStrategyGRPC() *HandlerStrategyGRPC {
	return &HandlerStrategyGRPC{}
}
