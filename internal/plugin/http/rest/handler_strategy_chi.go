...
func (s *HandlerStrategyChi) FormParams() (typ jen.Code) {
...
func (s *HandlerStrategyChi) MultipartFormParams(multipartMaxMemory int64) (typ jen.Code) {
	typ = jen.Custom(jen.Options{Multi: true},
...
func (s *HandlerStrategyChi) HandlerFunc(method string, pattern string, result, middlewares jen.Code, bodyFunc ...jen.Code) jen.Code {
